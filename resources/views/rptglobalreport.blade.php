        ...
        function fill_datatable(filter_gudang = '', show0 = 'TIDAK')
        {
            var Xcolumns=
                [
                    ...
                    {title: 'Saldo', data: 'saldo', name: 'saldo', render: $.fn.dataTable.render.number('.', ',', 0, ''), className: 'dt-body-right'},
                    {title: 'Qty di pesan', data: 'qtydipesan', name: 'qtydipesan', render: $.fn.dataTable.render.number('.', ',', 0, ''), className: 'dt-body-right'},
                    {title: 'Sisa Saldo', data: 'sisasaldo', name: 'sisasaldo', render: $.fn.dataTable.render.number('.', ',', 0, ''), className: 'dt-body-right'}
                ];
